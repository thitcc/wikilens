...
5. **`chore/third-party-licenses`** (added 2026-09-04, merges between 3 and
   ...
   for the ~290 Windows-target crates + a zero-dependency walk of
...
- License texts ship as a bundled resource next to the exe, not as
  ...
  ~290 statically linked crates carry the same notice obligation. The
...
- 2026-09-04 — branch 5 opened after an external review of the four PRs
  ...
  `THIRD-PARTY-LICENSES.txt` beside `wikilens.exe`; 286 crates, 89 packages,
  292 KB, byte-identical across regenerations.
